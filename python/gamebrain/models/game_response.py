...
class GameResponse(BaseModel):
    ...
    platforms: Optional[List[GameResponsePlatformsInner]] = None
    tags: Optional[List[StrictStr]] = None
    genres: Optional[List[GameResponsePlatformsInner]] = None
    genre: Optional[StrictStr] = None
    themes: Optional[List[GameResponsePlatformsInner]] = None
    adult_only: Optional[StrictBool] = None
    play_modes: Optional[List[GameResponsePlatformsInner]] = None
    screenshots: Optional[List[StrictStr]] = None
    videos: Optional[List[StrictStr]] = None
    offers: Optional[List[GameResponseOffersInner]] = None
    official_stores: Optional[List[GameResponseOfficialStoresInner]] = None
