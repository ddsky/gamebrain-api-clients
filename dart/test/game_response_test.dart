...
// tests for GameResponse
void main() {
  // final instance = GameResponse();

  group('test GameResponse', () {
    // int id
    ...
    // List<GameResponsePlatformsInner> platforms (default value: const [])
    ...
    // List<GameResponsePlatformsInner> genres (default value: const [])
    ...
    // List<GameResponsePlatformsInner> themes (default value: const [])
    ...
    // List<GameResponsePlatformsInner> playModes (default value: const [])
    ...
    // List<GameResponseOffersInner> offers (default value: const [])
    test('to test the property `offers`', () async {
      // TODO
    });

    // List<GameResponseOfficialStoresInner> officialStores (default value: const [])
